...
public class ModSounds {
    ...
    public static final BlockSoundGroup MAGIC_BLOCK_SOUNDS =
           new BlockSoundGroup(1F, 1F, MAGIC_BLOCK_BREAK, MAGIC_BLOCK_STEP,
    ...
    public static final RegistryKey<JukeboxSong> BAR_BRAWL_KEY =
           RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(Hyla.MOD_ID, "bar_brawl"));

    // CUSTOM METHOD - Register all Hyla path sounds
    private static SoundEvent registerSoundEvent(String name) {
        Identifier id = Identifier.of(Hyla.MOD_ID, name);
        return Registry.register(Registries.SOUND_EVENT, id, SoundEvent.of(id));
    }

    // CUSTOM METHOD - Register all Hyla sounds
    public static void registerSounds() {
        Hyla.LOGGER.info("Registering Mod Sounds for " + Hyla.MOD_ID);
    }
}